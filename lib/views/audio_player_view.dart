          ...
          if (state is AudioPlayerInitialState) {
            ...
            return Column(
              children: [
                        ...
                        children: [
                          Expanded(
                            child: TextField(
                              ...
                              decoration: InputDecoration(
                                hintText: 'Search',
                                hintStyle:
                                    TextStyle(color: mainColor.withAlpha(120)),
                                ...
                                enabledBorder: const OutlineInputBorder(
                                  borderSide: BorderSide(
                                      color: additionalColor, width: 2.0),
                                ),
                          ...
                          Container(
                            ...
                            decoration: BoxDecoration(
                              ...
                              border:
                                  Border.all(color: additionalColor, width: 2),
                              color: secondaryColor,
                            ),
                            child: Theme(
                ...
                buildReadyTrackList(state, editingController),
              ],
            );
...
Widget buildReadyTrackList(
    AudioPlayerReadyState state, TextEditingController editingController) {
  return Expanded(
...
List<AudioPlayerModel> sortAllList(List<AudioPlayerModel> list, String order) {
  if (order == 'By title') {
    list.sort((a, b) {
