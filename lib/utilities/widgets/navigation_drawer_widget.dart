                ...
                child: Column(
                  children: [
                    ...
                    buildMenuItem(
                      ...
                      onClicked: () => selectedItem(context, 1, user),
                    ),
                    const SizedBox(
                      height: 16,
                    ),
                    buildMenuItem(
                        ...
                        onClicked: () => selectedItem(context, 2, user)),
                    const SizedBox(
                      height: 16,
                    ),
                    buildMenuItem(
                      ...
                      onClicked: () => selectedItem(context, 3, user),
                    ),
                    const SizedBox(
                      height: 16,
                    ),
                    buildMenuItem(
                      ...
                      onClicked: () => selectedItem(context, 4, user),
                    ),
                    const SizedBox(
                      height: 16,
                    ),
                    buildMenuItem(
                      ...
                      onClicked: () => selectedItem(context, 5, user),
                    ),
                    const SizedBox(
                      height: 16,
                    ),
  ...
  selectedItem(BuildContext context, int index, AuthUser? user) async {
    switch (index) {
      ...
      case 4:
        ...
        for (var name in user!.userFavorites!) {
        ...
        BlocProvider.of<AudioPlayerBloc>(context)
            .add(InitializeAudioPlayerEvent(favoritesList));
        Navigator.of(context).pop();
        Navigator.of(context).push(MaterialPageRoute(
